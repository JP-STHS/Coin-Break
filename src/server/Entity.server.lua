...
SpawnedLevels.ChildAdded:Connect(function(level)
    ...
    local entitymodel = level:WaitForChild("Monster1")
    ...
    local safeZone = level:WaitForChild("closet")
    local door = level:WaitForChild("Door3")


    local waypoints = {
        level:WaitForChild("Waypoint1"),
        level:WaitForChild("Waypoint2"),
        level:WaitForChild("Waypoint3"),
        level:WaitForChild("Waypoint4"),
        level:WaitForChild("Waypoint5"),
        level:WaitForChild("Waypoint6"),
        level:WaitForChild("Waypoint7"),
        level:WaitForChild("Waypoint8")
    }
    ...
    task.wait(1)
    local lights = {}
    for _, v in pairs(level:GetDescendants()) do
